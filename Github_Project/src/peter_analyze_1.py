...
data_dir1 = '/Users/yuanjielu/Desktop/CEIE Project/Peter/col_1.csv'
data_dir2 = '/Users/yuanjielu/Desktop/CEIE Project/Peter/con_1.csv'
...
for i in range(len(dataSet1)):
    ...
    for j in range(len(dataSet2)):
        if dataSet2['Max Lanes Closed'].iloc[j] != None:
...
print('Collision for week, duringConstruction')
weekday_1 = pd.value_counts(duringContruction['Start time'].dt.weekday,sort = False)
# print(weekday_1)

print('Collision for week, noConstruction')
